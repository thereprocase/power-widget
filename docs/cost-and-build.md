...
| Two local supplies | TPS7A43 / TLV75533 (allowance needs requote) | 1.50–4.00 |
...
| M1 — bench capture | Complete sensing/MCU/debug circuit, connector specification and firmware contract | Native ERC clean; selected 5 A USB bench population; 9 A assembly sourcing remains open |
